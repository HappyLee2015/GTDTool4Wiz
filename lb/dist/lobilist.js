    ...
    List.prototype = {
        ...
        _init: function () {
            ...
            if (!me.$options.id) {
                ...
                //lip comment it because wiz plugin code will set it
                ...
                update: function (event, ui) {
                    ...
                    if ($children.length > 0) {
                        if (me != oldList){
                            ...
                            //lip listId also need change,can be move this to wiz plugin code
            ...
            if (me.$options.sortable) {
                me.$el.sortable({
                    ...
                    update: function (event, ui) {
                        ...
                        //lip
                        //alert("_handleSortable afterListReorder");
                    }
                });
            } else {
                //lip
